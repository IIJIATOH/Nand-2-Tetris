...
func main() {
	// Определение флагов
	translateCmd.Flags().StringVarP(&pathToFile, "path", "p", "C:/Users/mikhailovpa.DESKTOP-OKO95JV/Downloads/nand/nand2tetris/projects/7/vmModule/TEST.vm", "A path to file to translate")
